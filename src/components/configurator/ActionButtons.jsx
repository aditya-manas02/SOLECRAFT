...
export default function ActionButtons() {
    ...
    const handleSave = async () => {
        if (!isAuthenticated) { addToast('Please sign in to save designs', 'warning'); router.push('/auth'); return; }
        setIsSaving(true);
        try {
    ...
    const handleSavePublic = async () => {
        if (!isAuthenticated) { addToast('Please sign in first', 'warning'); router.push('/auth'); return; }
        setIsSaving(true);
        try {
