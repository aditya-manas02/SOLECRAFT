    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6" style={{ backgroundColor: 'var(--color-bg)' }}>
            <div className="text-center animate-fade-in">
                ...
                <Link href="/" className="px-10 py-4 bg-[#E85D26] text-white text-xs tracking-[0.3em] uppercase font-mono hover:bg-[#D14F1E] transition-colors hover:shadow-[0_0_30px_rgba(232,93,38,0.3)]">
                    Back to Home
                </Link>
            </div>
        </div>
