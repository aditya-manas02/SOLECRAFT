...
export default function SharedDesign() {
    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center animate-fade-in" style={{ backgroundColor: 'var(--color-bg)' }}>
    ...
    if (error) return (
        <div className="min-h-screen flex items-center justify-center animate-fade-in" style={{ backgroundColor: 'var(--color-bg)' }}>
            <div className="text-center">
                ...
                <Link href="/" className="px-8 py-3 bg-[#E85D26] text-white text-xs tracking-[0.3em] uppercase">Go Home</Link>
            </div>
        </div>
    );

    return (
        <div className="h-[calc(100vh-4rem)] flex flex-col animate-fade-in" style={{ backgroundColor: 'var(--color-bg)' }}>
            {/* Info bar */}
