...
export default function Gallery() {
    ...
    return (
        <div className="min-h-screen pt-20 pb-16 animate-fade-in" style={{ backgroundColor: 'var(--color-bg)' }}>
            {/* Header */}
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-8 py-12">
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <Link href="/configure/1" className="px-8 py-3 bg-[#E85D26] text-white text-xs tracking-[0.3em] uppercase">
                            Create Design
                        </Link>
                    </div>
                ) : (
                        ...
                        {designs.map((design, i) => (
                            <div key={design.id} className={`border overflow-hidden group ${cardBg}`}
                                ...
                                <div className="p-5">
                                    ...
                                    {design.share_token && (
                                        <Link href={`/shared/${design.share_token}`}
