...
export default function Home() {
    ...
    return (
        <div className="min-h-screen font-mono animate-fade-in" style={{ backgroundColor: 'var(--color-bg)' }}>
            {/* ─── HERO SECTION ─── */}
            <section
            ...
            >
                ...
                <div className="relative z-10 text-center px-6" style={{ transform: `translateY(${scrollY * -0.1}px)` }}>
                    <div className="text-[10px] tracking-[0.6em] text-[#E85D26] mb-8 uppercase font-bold">
                        EST. 2026 // PREMIUM CUSTOM STUDIO
                    </div>
                    <h1 className="text-7xl md:text-[140px] font-bold text-white tracking-[0.15em] leading-none mb-8 drop-shadow-2xl">
            ...
            {/* ─── FEATURED SHOES ─── */}
            <section className="py-40 px-8" style={{ backgroundColor: '#111' }}>
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
                        ...
                        <Link href="/collections" className="text-[10px] tracking-[0.4em] text-gray-500 uppercase hover:text-[#E85D26] transition-colors pb-2 border-b border-gray-800">
