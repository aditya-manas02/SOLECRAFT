            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                {loading ? (
                    ...
                    <div className={`p-10 text-center border ${cardBg}`}>
                        ...
                        <Link href="/collections" className="inline-block px-8 py-3 bg-[#E85D26] text-white text-[10px] tracking-widest uppercase hover:bg-[#D14F1E] transition-colors">
                            Explore Collections
                        </Link>
                    </div>
                ) : (
                    <div className="grid md:grid-cols-3 gap-8">
                                ...
                                <div key={item.id} className={`p-5 flex justify-between border ${cardBg}`}>
                                    <div>
                                        ...
                                        <div className="flex gap-2 mb-2">
                                            {item.color_zones && Object.entries(item.color_zones).map(([zone, color]) => (
                                    ...
                                    <div className="text-right flex flex-col justify-between">
                                        ...
                                        <button onClick={() => handleRemove(item.id)} className="text-[10px] text-red-500 hover:underline uppercase tracking-widest cursor-pointer">
                                            Remove
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className={`p-6 border sticky top-24 ${cardBg}`}>
                                ...
                                <button onClick={handleCheckout} className="w-full py-4 bg-[#E85D26] text-white text-[10px] tracking-[0.2em] uppercase hover:bg-[#D14F1E] transition-colors cursor-pointer">
                                    Checkout
                                </button>
                            </div>
                        </div>
