            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className={`p-8 border mb-8 ${card}`}>
                    ...
                    <form onSubmit={handleUpdate} className="space-y-5">
                        ...
                        <button type="submit" disabled={saving} className="px-8 py-3 bg-[#E85D26] text-white text-xs tracking-[0.3em] uppercase hover:bg-[#D14F1E] transition-colors disabled:opacity-50 cursor-pointer">
                ...
                <div className={`p-8 border ${card}`}>
                    ...
                    <form onSubmit={handlePasswordChange} className="space-y-5">
                        ...
                        <button type="submit" disabled={changingPw} className="px-8 py-3 border text-xs tracking-[0.3em] uppercase hover:bg-[#E85D26] hover:text-white transition-colors disabled:opacity-50 cursor-pointer"
