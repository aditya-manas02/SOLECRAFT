                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <div>
                        ...
                        <form onSubmit={handlePlaceOrder} className="space-y-4">
                            ...
                            <button type="submit" disabled={placing} className="w-full mt-6 py-4 bg-[#E85D26] text-white text-[10px] tracking-[0.2em] uppercase hover:bg-[#D14F1E] transition-colors disabled:opacity-50 cursor-pointer">
